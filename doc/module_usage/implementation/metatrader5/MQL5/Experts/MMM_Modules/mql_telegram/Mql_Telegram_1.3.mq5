...
//--- create timer
   EventSetTimer(60);
	...
	Sleep(1000);
	string resultOfSetDefaultValue = SetDefaultValue("ParseMode", "html");
	Sleep(1000);
	...
	Sleep(1000);
	string resultOfSendDocument = SendDocument("-1001167825793", "D:/pathToFile/log.txt");
	Sleep(1000);
	string resultOfStartSendDocument = StartSendDocument("-1001167825793", "D:/pathToFile/log.txt");
	Sleep(1000);
	...
	Sleep(1000);
	string resultOfStartSendText = StartSendText("-1001167825793", "Some text in <b>bold</b> with smile emoji: \U+1F601");
	Sleep(1000);
