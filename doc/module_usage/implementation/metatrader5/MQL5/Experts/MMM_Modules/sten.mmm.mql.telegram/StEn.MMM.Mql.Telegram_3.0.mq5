...
// Available functions:
	...
	// string GetMe();
	// string StartGetMe();
	// string GetUpdates(int offset, int limit);
	// string StartGetUpdates(int offset, int limit);
...
//--- create timer
   EventSetTimer(60);
	...
	Sleep(1000);
	string resultOfGetUpdates = TelegramModule::GetUpdates(0, 0);
	Sleep(1000);
	string resultOfStartGetUpdates = TelegramModule::StartGetUpdates(0, 0);
	Sleep(1000);
